...
static void load_from_byte(u8 reg, char dst[restrict 6]) {
...
CU_pSuite register_s390x_tests(void) {
    CU_pSuite suite;
    INIT_SUITE(suite);
    ADD_DISASM_TEST(suite, test_load_store);
    ADD_DISASM_TEST(suite, test_reg_copy);
    ADD_DISASM_TEST(suite, test_set_reg_zero);
    ADD_DISASM_TEST(suite, test_set_reg_small_imm);
    ADD_DISASM_TEST(suite, test_set_reg_medium_imm);
    ADD_DISASM_TEST(suite, test_set_reg_large_imm);
    ADD_DISASM_TEST(suite, test_successful_jumps);
    ADD_DISASM_TEST(suite, test_syscall);
    ADD_DISASM_TEST(suite, test_set_byte);
    ADD_DISASM_TEST(suite, test_reg_arith_small_imm);
    ADD_DISASM_TEST(suite, test_reg_arith_medium_imm);
    ADD_DISASM_TEST(suite, test_reg_arith_large_imm);
    ADD_TEST(suite, test_add_sub_i64_min);
    ADD_DISASM_TEST(suite, test_byte_arith);
