...
size_t serialize64le(uint64_t v64, void *dest);
...
size_t serialize_phdr64_le(Elf64_Phdr* phdr, void* dest); /* Elf64_Phdr */

/* The same as the above, except in MSB order. */
size_t serialize16be(uint16_t v16, void *dest);
size_t serialize32be(uint32_t v32, void *dest);
size_t serialize64be(uint64_t v64, void *dest);
size_t serialize_ehdr64_be(Elf64_Ehdr* ehdr, void* dest); /* Elf64_Ehdr */
size_t serialize_phdr64_be(Elf64_Phdr* phdr, void* dest); /* Elf64_Phdr */
