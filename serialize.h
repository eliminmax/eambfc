...
nonnull_args size_t serialize64le(u64 v64, void *dest);
...
nonnull_args size_t
serialize_ehdr64_le(Elf64_Ehdr *ehdr, void *dest); /* Elf64_Ehdr */
nonnull_args size_t
...
nonnull_args size_t serialize64be(u64 v64, void *dest);
nonnull_args size_t
serialize_ehdr64_be(Elf64_Ehdr *ehdr, void *dest); /* Elf64_Ehdr */
nonnull_args size_t
