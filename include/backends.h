 ...
 * macro definitions, would allow the same information to be interpreted
...
/* provides the canonical name of a disabled architecture, in case a disabled
 * architecture is selected at the command line */
#ifndef ARCH_INTER_DISABLED
...
#else
ARCH_INTER_DISABLED("arm64", "aarch64")
...
#else
ARCH_INTER_DISABLED("i386", "i486", "i586", "i686")
...
#else
ARCH_INTER_DISABLED("riscv64", "riscv")
...
#else
ARCH_INTER_DISABLED("s390x", "s390", "z/architecture")
...
#else
ARCH_INTER_DISABLED("x86_64", "x64", "amd64", "x86-64")
